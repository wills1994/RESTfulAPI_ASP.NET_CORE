...
namespace CourseLibrary.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                setupAction.ReturnHttpNotAcceptable = true;// 406 Not Acceptable(solo se admite los formatos de json o xml)
            ...
            }).AddXmlDataContractSerializerFormatters() //Se acepta los ficheros de xml
