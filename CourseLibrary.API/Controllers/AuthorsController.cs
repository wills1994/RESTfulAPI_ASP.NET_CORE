...
https://github.com/KevinDockx/BuildingRESTfulAPIAspNetCore3/blob/master/Finished%20sample/CourseLibrary/CourseLibrary.API/Controllers/AuthorsController.cs
  
Paging, sorting, data shaping, HATEOAS, advanced content negotation, custom media types, caching (in-depth) and concurrency. 
https://github.com/KevinDockx/ImplementingAdvancedRESTfulConcernsAspNetCore3

HATEOAS. ofrecer una interfaz universal. El cliente pueda moverse por la aplicación web únicamente siguiendo a
...
namespace CourseLibrary.API.Controllers
{
    ...
    public class AuthorsController:ControllerBase
    {
        ...
        //[HttpHead] //No se devuelve el cuerpo de response
        // Implementamos Shaping Data si queremos filtrar por los campos en url de api
        // Cambiamos por ActionResult<IEnumerable<AuthorDto>> a ActionResult
           ...
           [FromQuery] AuthorsResourceParameters authorsResourceParameters)
        {
            ...
            //Comprobar si existen esas propiedades
            ...
            //Multiple Resources - Shaped Object - IEnumerableExtensions
        ...
        public IActionResult GetAuthor(Guid authorId, string fields, [FromHeader(Name = "Accept")] string mediaType)
        {
            ...
            //Object Extension - Single Resource
            // friendly author
